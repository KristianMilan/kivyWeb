...
% include('menus.tpl', licensing=True, license=True)  
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Vision SIP Server</h1>
    </section>
    <section class="content">
      <form id="form1" name="form1" method="post" action="/setVisionSIP">
        <div class="row">
          <div class="col-md-6">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="profile-username">Enter New Vision SIP Server</h3>
                </div>
                <div class="box-body box-profile">
                  <div class="form-group">
                    <label>Vision SIP Server: (Format: URL)</label>
                    <input type="text" class="form-control" name="server" id="server" value="{{visionsip if visionsip else ''}}">
                  </div>
                </div>    
