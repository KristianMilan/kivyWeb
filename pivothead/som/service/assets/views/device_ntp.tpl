...
% include('menus.tpl', livemodpro=True, deviceSettings=True)  
  <div class="content-wrapper">
    ...
    <section class="content">
      <form id="form1" name="form1" method="post" action="/device/ntp/set">
        <div class="row">
          <div class="col-md-6">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="profile-username">Enter New NTP Server</h3>
                </div>
                <div class="box-body box-profile">
                  <div class="form-group">
                    <label>NTP Server:</label>
                    <input type="text" class="form-control" name="server" id="server" value="{{server if server else ''}}">
