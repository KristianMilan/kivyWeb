...
% include('menus.tpl', network=True, nettool=True, tcpdump=True)  
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body box-profile">
                        <ul class="list-group list-group-unbordered">
                            ...
                            <form action="/network/tcpdump/save" method="post" id="tcpForm">  
                                
                                <input type="hidden" name="redirect" value="/network/tcpdump">
                              %if isRunning:    
                            ...
                            <li class="list-group-item">
                              ...
                              <span class="pull-right">
                                <a id="downloadBtn" href="/network/tcpdump/download" class="pull-right btn btn-xs btn-primary">Download</a>
                              </span>                                
                            </li>
                            <li class="list-group-item">
                              <b>TCP Dmp Clean File</b> 
                              <span class="pull-right">
                                <a id="downloadBtn" href="/network/tcpdump/remove" class="pull-right btn btn-xs btn-primary">Clean</a>
                              </span>                                
                            </li>
                            %end
                        </ul>
